    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateField(verbose_name='Fecha de registro')),
                ('create_at', models.DateField(auto_now_add=True, null=True, verbose_name='Creado el')),
                ('modify_at', models.DateField(auto_now=True, verbose_name='Actualizado el')),
                ('id_elemento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proveedores.elementos')),
